...
const Header = () =>{
    ...
    return(
            <div className="flex justify-between p-2 bg-emerald-500 shadow-md items-center">
                ...
                <div>
                    <ul className="menu-bar list-none flex gap-3 pr-3">
                        ...
                        <li className="ml-5"><Link to='/update-user'><img className="w-12 h-12 rounded-full" src={photo} alt="user-logo"/></Link></li>
                    </ul>
                </div>
            </div>
    )
